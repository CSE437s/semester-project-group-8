...
function PostSignupForm() {
  ...
  const handleInputChange = (field, value) => {
    const updatedValue =
      field === "workoutIntensity" ? parseInt(value, 10) : value;
    setFormData((prev) => ({
      ...prev,
      [field]: updatedValue,
    }));
      ...
      <>
        ...
        <form onSubmit={handleVerificationSubmit}>
          <IonItem>
            ...
            <IonInput
              value={code}
              onIonChange={handleVerificationInputChange}
              type="number"
              inputmode="numeric"
            />
          </IonItem>
    ...
    return (
      <div className="welcome-step">
        ...
        <IonText className="welcome-text">
          ...
          <h3>
            The following information helps us refine our lifting
            recommendations.
          </h3>
        </IonText>
      </div>
    ...
    return (
      <div className="goal-page">
        ...
        <IonItem>
          ...
          >
            <IonSelectOption value="Muscle Building">
              Muscle Building
            </IonSelectOption>
            <IonSelectOption value="Strength Building">
              Strength Building
            </IonSelectOption>
            <IonSelectOption value="Overall fitness">
              Overall fitness
            </IonSelectOption>
            <IonSelectOption value="Toning">Toning</IonSelectOption>
            <IonSelectOption value="Cardiovascular Fitness">
      ...
      <div className="goal-page">
        ...
        <IonItem>
          <IonLabel position="stacked">
            Workout Intensity Preference (1-10)
          </IonLabel>
          <IonRange
            ticks={true}
            snaps={true}
            ...
            onIonChange={(e) =>
              handleInputChange("workoutIntensity", e.detail.value)
            }
          ></IonRange>
        </IonItem>
    ...
    <div>
      ...
      {currentStep <= TOTAL_STEPS && (
        <div className="nav-buttons">
          {currentStep > 2 && (
            <IonButton className="next-back-button" onClick={prevStep}>
              Back
            </IonButton>
          )}
          {currentStep !== 1 && currentStep <= TOTAL_STEPS && (
            <IonButton className="next-back-button" onClick={nextStep}>
              Next
            </IonButton>
          )}
        </div>
